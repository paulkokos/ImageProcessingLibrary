//
// Created by paulkokos on 9/6/2020.
//
...
void
ImageProcessing::brigthnessUp(unsigned char *_inputImgData, unsigned char *_outImgData, int imgSize, int brightness) {
...
void
ImageProcessing::brigthnessDown(unsigned char *_inputImgData, unsigned char *_outImgData, int imgSize, int darkness) {
    for (int i = 0; i < imgSize; i++) {
...
void ImageProcessing::computeHistogram2(unsigned char *_imgData, int imgRows, int imgCols, float hist[],
                                        const char *histFile) {
    FILE *fptr;
...
void ImageProcessing::equalizeHistogram(unsigned char *_inputImgData, unsigned char *_outputImgData, int imgRows,
                                        int imgCols) {
    int x, y, i, j;
    int histeq[256];
    float hist[256];
...
void
ImageProcessing::getImageNegative(unsigned char *_inImgData, unsigned char *_outImgData, int imgWidth, int imgHeight) {
...
void ImageProcessing::Convolve2D(int imgRows, int imgCols, struct Mask *myMask, unsigned char *input_buf,
...
void ImageProcessing::detectLine(unsigned char *_inputImgData, unsigned char *_outputImgData, int imgCols, int imgRows,
                                 const int MASK[][3]) {
...
void
ImageProcessing::generateGaussNoise(unsigned char *_inputImgData, int imgCols, int imgRows, float var, float mean) {
    int x, y;
    float theta, noise;
    for (y = 0; y < imgRows; y++)
        for (x = 0; x < imgCols; x++) {
...
void
ImageProcessing::medianFilter(unsigned char *_inputImgData, unsigned char *_outputImgData, int imgCols, int imgRows) {
    int x, y, i, j, z;
    int n, ar[121], a;
    n = 7;
...
void
ImageProcessing::minimumFilter(unsigned char *_inputImgData, unsigned char *_outputImgData, int imgCols, int imgRows) {
